  ...
  function GlassCard({ project, i }) {
    ...
    const handleMouseMove = (e) => {
      ...
      const rotateX = ((y / card.height) - 0.5) * -20; // tilt up/down
      const rotateY = ((x / card.width) - 0.5) * 20;  // tilt left/right
    ...
    return (
      ...
      >
        {/* Title */}
        <h3 className="text-2xl font-semibold text-white mb-3 group-hover:text-gray-100 transition">
          {project.title}
        </h3>
  ...
  export default function ProjectsSection() {
    return (
      <section id="projects" className="w-full min-h-screen bg-gradient-to-b from-black via-[#0a0a0a] to-black flex flex-col items-center justify-center px-6 py-20">
        {/* Heading */}
        <motion.h2
        ...
        >
          <DecoderText text="My Projects" delay={100} speed={40} />
        </motion.h2>
